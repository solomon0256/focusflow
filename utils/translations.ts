...
const en = {
  ...
  footer: {
      version: 'FocusFlow v1.3.0 (Build 2024.1)',
...
export const translations: Record<LanguageCode, TranslationKeys> = {
  ...
  zh: {
    ...
    footer: { version: 'FocusFlow v1.3.0 (内部版本 2024.1)', architecture: 'Local-First 隐私优先架构' },
  ...
  'zh-TW': {
    ...
    footer: { version: 'FocusFlow v1.3.0 (版本 2024.1)', architecture: 'Local-First 隱私優先架構' },
  ...
  fr: {
    ...
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: 'Architecture Local-First' },
  },
  // 日本語 (Japanese)
  ja: {
    ...en,
    settings: { ...en.settings, title: '設定', performance: 'パフォーマンス', powerSaver: '省電力モード', powerSaverDesc: 'AI検出頻度を下げてバッテリーを節約します。' },
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: 'ローカルファースト・アーキテクチャ' },
  },
  // 한국어 (Korean)
  ko: {
    ...en,
    settings: { ...en.settings, title: '설정', performance: '성능', powerSaver: '절전 모드', powerSaverDesc: '배터리 절약을 위해 AI 감지 빈도를 줄입니다.' },
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: '로컬 우선 아키텍처' },
  },
  // Español (Spanish)
  es: {
    ...en,
    ...
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: 'Arquitectura Local-First' },
  },
  // Русский (Russian)
  ru: {
    ...en,
    ...
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: 'Архитектура Local-First' },
  },
  // العربية (Arabic)
  ar: {
    ...en,
    ...
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: 'بنية Local-First' },
  },
  // Deutsch (German)
  de: {
    ...en,
    ...
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: 'Local-First Architektur' },
  },
  // हिन्दी (Hindi)
  hi: {
    ...en,
    ...
    footer: { version: 'FocusFlow v1.3.0 (Build 2024.1)', architecture: 'स्थानीय-प्रथम वास्तुकला' },
  }
};
