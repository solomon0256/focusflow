...
export const translations: Record<LanguageCode, TranslationKeys> = {
  ...
  zh: {
    ...
    stats: { title: '数据统计', focusHours: '小时', today: '今日专注', tasksDone: '完成任务', weeklyActivity: '周活跃度', last7Days: '最近7天', focusMaster: '专注达人', companion: '你的伙伴', petName: '专注狐', happiness: '开心值', level: 'Lv.', tapCollapse: '点击收起', tapExpand: '多专注来喂养它！', deepFocus: '深度专注', focused: '专注中', zoningOut: '游离', distracted: '分心' },
    settings: { title: '设置', proTitle: 'FocusFlow Pro', proDesc: '云端同步 & 支持开发者', viewOffer: '查看详情', proMember: 'Pro 会员', thanks: '感谢您的支持！', cloudSync: '云同步', enableCloud: '开启云同步', signOut: '退出登录', timerConfig: '计时器配置', focusDuration: '专注时长', shortBreak: '短休息', longBreak: '长休息', intervals: '长休息间隔', language: '语言', support: '支持', restore: '恢复购买', privacy: '隐私政策', reset: '重置', choosePlan: '选择方案', recurring: '自动续费，随时取消。继续即代表同意服务条款和隐私政策。', subscribe: '订阅 价格:' },
    premium: { feat_sync: '多端同步 (iOS/Android)', feat_history: '无限历史记录与统计', feat_skins: '解锁“专注狐”限定皮肤', feat_noise: '高级白噪音库', feat_support: '支持独立开发者 ❤️', monthly_name: '月度会员', monthly_desc: '按月付费，随时取消。', yearly_name: '年度会员', yearly_desc: '12个月超值优惠。', yearly_tag: '省 45%', lifetime_name: '终身买断', lifetime_desc: '一次付费，永久拥有。', lifetime_tag: '最超值' },
  ...
  'zh-TW': {
    ...
    stats: { title: '數據統計', focusHours: '小時', today: '今日專注', tasksDone: '完成任務', weeklyActivity: '週活躍度', last7Days: '最近7天', focusMaster: '專注達人', companion: '你的夥伴', petName: '專注狐', happiness: '開心值', level: 'Lv.', tapCollapse: '點擊收起', tapExpand: '多專注來餵養牠！', deepFocus: '深度專注', focused: '專注中', zoningOut: '遊離', distracted: '分心' },
    settings: { title: '設定', proTitle: 'FocusFlow Pro', proDesc: '雲端同步 & 支持開發者', viewOffer: '查看詳情', proMember: 'Pro 會員', thanks: '感謝您的支持！', cloudSync: '雲同步', enableCloud: '開啟雲同步', signOut: '登出', timerConfig: '計時器配置', focusDuration: '專注時長', shortBreak: '短休息', longBreak: '長休息', intervals: '長休息間隔', language: '語言', support: '支持', restore: '恢復購買', privacy: '隱私政策', reset: '重置', choosePlan: '選擇方案', recurring: '自動續費，隨時取消。繼續即代表同意服務條款和隱私政策。', subscribe: '訂閱 價格:' },
    premium: { feat_sync: '多端同步 (iOS/Android)', feat_history: '無限歷史記錄與統計', feat_skins: '解鎖“專注狐”限定皮膚', feat_noise: '高級白噪音庫', feat_support: '支持獨立開發者 ❤️', monthly_name: '月度會員', monthly_desc: '按月付費，隨時取消。', yearly_name: '年度會員', yearly_desc: '12個月超值優惠。', yearly_tag: '省 45%', lifetime_name: '終身買斷', lifetime_desc: '一次付費，永久擁有。', lifetime_tag: '最超值' },
  ...
  fr: {
    ...
    stats: { title: 'Statistiques', focusHours: 'h', today: 'Aujourd\'hui', tasksDone: 'Tâches finies', weeklyActivity: 'Activité Hebdo', last7Days: '7 derniers jours', focusMaster: 'Maître Focus', companion: 'Compagnon', petName: 'Renard Focus', happiness: 'BONHEUR', level: 'Niv.', tapCollapse: 'Réduire', tapExpand: 'Concentrez-vous pour nourrir !', deepFocus: 'Focus Profond', focused: 'Concentré', zoningOut: 'Distrait', distracted: 'Interrompu' },
    ...
    premium: { feat_sync: 'Synchro iPhone, iPad & Android', feat_history: 'Historique & Stats illimités', feat_skins: 'Skins exclusifs "Renard Focus"', feat_noise: 'Bruit blanc avancé', feat_support: 'Soutenez un dév indé ❤️', monthly_name: 'Mensuel', monthly_desc: 'Facturé chaque mois.', yearly_name: 'Annuel', yearly_desc: '12 mois au meilleur prix.', yearly_tag: '-45%', lifetime_name: 'À vie', lifetime_desc: 'Paiement unique.', lifetime_tag: 'BEST SELLER' },
  ...
  ja: {
    ...
    stats: { title: '統計データ', focusHours: '時間', today: '今日の集中', tasksDone: '完了タスク', weeklyActivity: '週間アクティビティ', last7Days: '過去7日間', focusMaster: '集中マスター', companion: 'パートナー', petName: 'フォーカス狐', happiness: '幸福度', level: 'Lv.', tapCollapse: 'タップして縮小', tapExpand: '集中して育てよう！', deepFocus: '深い集中', focused: '集中', zoningOut: '注意散漫', distracted: '離脱' },
  ...
  ko: {
    ...
    stats: { title: '통계', focusHours: '시간', today: '오늘 집중', tasksDone: '완료된 작업', weeklyActivity: '주간 활동', last7Days: '최근 7일', focusMaster: '집중 마스터', companion: '반려 동물', petName: '포커스 여우', happiness: '행복도', level: 'Lv.', tapCollapse: '접기', tapExpand: '집중해서 키우세요!', deepFocus: '깊은 집중', focused: '집중함', zoningOut: '멍때림', distracted: '산만함' },
    settings: { title: '설정', proTitle: 'FocusFlow Pro', proDesc: '동기화 및 개발 지원', viewOffer: '혜택 보기', proMember: 'Pro 멤버', thanks: '지원해 주셔서 감사합니다!', cloudSync: '클라우드 동기화', enableCloud: '동기화 켜기', signOut: '로그아웃', timerConfig: '타이머 설정', focusDuration: '집중 시간', shortBreak: '짧은 휴식', longBreak: '긴 휴식', intervals: '긴 휴식 간격', language: '언어', support: '지원', restore: '구매 복원', privacy: '개인정보 처리방침', reset: '초기화', choosePlan: '요금제 선택', recurring: '정기 결제, 언제든지 취소 가능.', subscribe: '구독하기' },
    premium: { feat_sync: '모든 기기 동기화', feat_history: '무제한 기록 및 통계', feat_skins: '한정판 여우 스킨', feat_noise: '고급 화이트 노이즈', feat_support: '1인 개발자 후원 ❤️', monthly_name: '월간', monthly_desc: '매월 결제.', yearly_name: '연간', yearly_desc: '12개월 최저가.', yearly_tag: '45% 할인', lifetime_name: '평생', lifetime_desc: '한 번 결제로 평생 소장.', lifetime_tag: '추천' },
  ...
  ru: {
    ...
    stats: { title: 'Статистика', focusHours: 'ч', today: 'Сегодня', tasksDone: 'Сделано', weeklyActivity: 'Активность', last7Days: '7 дней', focusMaster: 'Мастер Фокуса', companion: 'Питомец', petName: 'Фокус Лис', happiness: 'СЧАСТЬЕ', level: 'Ур.', tapCollapse: 'Свернуть', tapExpand: 'Фокусируйся, чтобы кормить!', deepFocus: 'Поток', focused: 'Фокус', zoningOut: 'Витание', distracted: 'Отвлекся' },
    settings: { title: 'Настройки', proTitle: 'FocusFlow Pro', proDesc: 'Синхронизация и поддержка.', viewOffer: 'Подробнее', proMember: 'Pro Участник', thanks: 'Спасибо за поддержку!', cloudSync: 'Облако', enableCloud: 'Включить синхронизацию', signOut: 'Выйти', timerConfig: 'Настройки таймера', focusDuration: 'Длительность фокуса', shortBreak: 'Короткий перерыв', longBreak: 'Длинный перерыв', intervals: 'Интервалы', language: 'Язык', support: 'Поддержка', restore: 'Восстановить покупки', privacy: 'Конфиденциальность', reset: 'Сброс', choosePlan: 'Выберите план', recurring: 'Автопродление, отмена в любое время.', subscribe: 'Подписаться за' },
  ...
  ar: {
    ...
    stats: { title: 'الإحصائيات', focusHours: 'س', today: 'اليوم', tasksDone: 'المهام المنجزة', weeklyActivity: 'النشاط الأسبوعي', last7Days: 'آخر 7 أيام', focusMaster: 'سيد التركيز', companion: 'رفيقك', petName: 'ثعلب التركيز', happiness: 'السعادة', level: 'مستوى', tapCollapse: 'اضغط للطي', tapExpand: 'ركز أكثر لإطعامه!', deepFocus: 'تركيز عميق', focused: 'مركز', zoningOut: 'شارد الذهن', distracted: 'مشتت' },
    settings: { title: 'الإعدادات', proTitle: 'FocusFlow برو', proDesc: 'مزامنة البيانات ودعم التطوير.', viewOffer: 'عرض العرض', proMember: 'عضو برو', thanks: 'شكراً لدعمك!', cloudSync: 'مزامنة سحابية', enableCloud: 'تفعيل المزامنة', signOut: 'تسجيل الخروج', timerConfig: 'إعدادات المؤقت', focusDuration: 'مدة التركيز', shortBreak: 'استراحة قصيرة', longBreak: 'استراحة طويلة', intervals: 'الفترات', language: 'اللغة', support: 'الدعم', restore: 'استعادة المشتريات', privacy: 'الخصوصية', reset: 'إعادة تعيين', choosePlan: 'اختر خطة', recurring: 'دفع متكرر، إلغاء في أي وقت.', subscribe: 'اشتراك بـ' },
