...
export const translations: Record<LanguageCode, TranslationKeys> = {
  ...
  zh: {
    ...
    settings: { title: '设置', proTitle: 'FocusFlow Pro', proDesc: '云端同步 & 支持开发者', viewOffer: '查看详情', proMember: 'Pro 会员', thanks: '感谢您的支持！', cloudSync: '云同步', enableCloud: '开启云同步', signOut: '退出登录', timerConfig: '计时器配置', focusDuration: '专注时长', shortBreak: '短休息', longBreak: '长休息', intervals: '每轮番茄数', language: '语言', support: '支持', restore: '恢复购买', privacy: '隐私政策', reset: '重置', choosePlan: '选择方案', recurring: '自动续费，随时取消。继续即代表同意服务条款和隐私政策。', subscribe: '订阅 价格:', notifications: '通知提醒', addNotification: '添加时间', notifyAt: '提醒时间' },
  ...
  ja: {
    ...
    session: { complete: 'セッション完了！', focusedFor: '集中した時間', minutes: '分', avgFocus: '平均集中度', posture: '姿勢', timeline: 'タイムライン', cycleLog: 'サイクルログ', backHome: 'ホームへ戻る', recharge: 'リチャージタイム', rest: '休憩しましょう', breathe: '深呼吸して、遠くを見ましょう。', skipBreak: '休憩をスキップ', paused: '一時停止中', focusGuard: 'フォーカスガード', proPosture: 'Pro: 姿勢', fullBodyAi: '全身 AI', focusTime: '集中時間', taskCompleted: 'タスク完了', markAsDone: '完了にしますか？', sessionDoneAuto: 'セッション完了！タスクも完了しました。', sessionDoneManual: 'セッション終了。タスクは完了しましたか？', earlyStop: 'セッションを早期終了しました。' }
  },
  // 한국어 (Korean)
  ko: {
    ...
    settings: { title: '설정', proTitle: 'FocusFlow Pro', proDesc: '동기화 및 개발 지원', viewOffer: '혜택 보기', proMember: 'Pro 멤버', thanks: '지원해 주셔서 감사합니다!', cloudSync: '클라우드 동기화', enableCloud: '동기화 켜기', signOut: '로그아웃', timerConfig: '타이머 설정', focusDuration: '집중 시간', shortBreak: '짧은 휴식', longBreak: '긴 휴식', intervals: '라운드 당 뽀모도로', language: '언어', support: '지원', restore: '구매 복원', privacy: '개인정보 처리방침', reset: '초기화', choosePlan: '요금제 선택', recurring: '정기 결제, 언제든지 취소 가능.', subscribe: '구독하기', notifications: '알림 설정', addNotification: '시간 추가', notifyAt: '알림 시간' },
    ...
    session: { complete: '집중 완료!', focusedFor: '집중한 시간', minutes: '분', avgFocus: '평균 집중도', posture: '자세', timeline: '타임라인', cycleLog: '기록', backHome: '홈으로', recharge: '충전 시간', rest: '휴식하세요', breathe: '심호흡을 하고 먼 곳을 바라보세요.', skipBreak: '휴식 건너뛰기', paused: '일시정지됨', focusGuard: '포커스 가드', proPosture: 'Pro: 자세', fullBodyAi: '전신 AI', focusTime: '집중 시간', taskCompleted: '작업 완료', markAsDone: '완료로 표시하시겠습니까?', sessionDoneAuto: '세션 종료! 작업이 완료되었습니다.', sessionDoneManual: '세션 종료. 작업을 완료했습니까?', earlyStop: '세션이 조기 종료되었습니다.' }
  },
  // Español (Spanish)
  es: {
    ...
    settings: { title: 'Ajustes', proTitle: 'FocusFlow Pro', proDesc: 'Sincronización y apoyo.', viewOffer: 'Ver Oferta', proMember: 'Miembro Pro', thanks: '¡Gracias por tu apoyo!', cloudSync: 'Nube', enableCloud: 'Activar Sincronización', signOut: 'Cerrar Sesión', timerConfig: 'Config. Temporizador', focusDuration: 'Duración Foco', shortBreak: 'Descanso Corto', longBreak: 'Descanso Largo', intervals: 'Pomos / Ronda', language: 'Idioma', support: 'Soporte', restore: 'Restaurar Compras', privacy: 'Privacidad', reset: 'Reiniciar', choosePlan: 'Elige un plan', recurring: 'Facturación recurrente, cancela cuando quieras.', subscribe: 'Suscribirse por', notifications: 'Notificaciones', addNotification: 'Añadir', notifyAt: 'Notificar a' },
    ...
    session: { complete: '¡Sesión Completada!', focusedFor: 'Te has enfocado por', minutes: 'minutos', avgFocus: 'Foco Promedio', posture: 'Postura', timeline: 'Línea de tiempo', cycleLog: 'Registro', backHome: 'Volver al Inicio', recharge: 'Hora de recargar', rest: 'Descanso merecido', breathe: 'Respira hondo. Mira lejos.', skipBreak: 'Omitir descanso', paused: 'Pausado', focusGuard: 'Guardia de Foco', proPosture: 'Pro: Postura', fullBodyAi: 'IA Corporal', focusTime: 'Tiempo Foco', taskCompleted: 'Tarea completada', markAsDone: '¿Marcar como hecha?', sessionDoneAuto: '¡Sesión completa! Tarea marcada.', sessionDoneManual: 'Sesión terminada. ¿Tarea hecha?', earlyStop: 'Sesión detenida.' }
  },
  // Русский (Russian)
  ru: {
    ...
    settings: { title: 'Настройки', proTitle: 'FocusFlow Pro', proDesc: 'Синхронизация и поддержка.', viewOffer: 'Подробнее', proMember: 'Pro Участник', thanks: 'Спасибо за поддержку!', cloudSync: 'Облако', enableCloud: 'Включить синхронизацию', signOut: 'Выйти', timerConfig: 'Настройки таймера', focusDuration: 'Длительность фокуса', shortBreak: 'Короткий перерыв', longBreak: 'Длинный перерыв', intervals: 'Помодоро / Раунд', language: 'Язык', support: 'Поддержка', restore: 'Восстановить покупки', privacy: 'Конфиденциальность', reset: 'Сброс', choosePlan: 'Выберите план', recurring: 'Автопродление, отмена в любое время.', subscribe: 'Подписаться за', notifications: 'Уведомления', addNotification: 'Добавить', notifyAt: 'Время' },
  ...
  ar: {
    ...
    settings: { title: 'الإعدادات', proTitle: 'FocusFlow برو', proDesc: 'مزامنة البيانات ودعم التطوير.', viewOffer: 'عرض العرض', proMember: 'عضو برو', thanks: 'شكراً لدعمك!', cloudSync: 'مزامنة سحابية', enableCloud: 'تفعيل المزامنة', signOut: 'تسجيل الخروج', timerConfig: 'إعدادات المؤقت', focusDuration: 'مدة التركيز', shortBreak: 'استراحة قصيرة', longBreak: 'استراحة طويلة', intervals: 'بومودورو / جولة', language: 'اللغة', support: 'الدعم', restore: 'استعادة المشتريات', privacy: 'الخصوصية', reset: 'إعادة تعيين', choosePlan: 'اختر خطة', recurring: 'دفع متكرر، إلغاء في أي وقت.', subscribe: 'اشتراك بـ', notifications: 'الإشعارات', addNotification: 'إضافة', notifyAt: 'تنبيه في' },
    ...
    session: { complete: 'اكتملت الجلسة!', focusedFor: 'بقيت مركزاً لمدة', minutes: 'دقيقة', avgFocus: 'متوسط التركيز', posture: 'الوضعية', timeline: 'الجدول الزمني', cycleLog: 'سجل الدورات', backHome: 'عودة للرئيسية', recharge: 'وقت الشحن', rest: 'راحة مستحقة', breathe: 'تنفس بعمق. انظر بعيداً.', skipBreak: 'تخطي الاستراحة', paused: 'متوقف', focusGuard: 'حارس التركيز', proPosture: 'برو: الوضعية', fullBodyAi: 'ذكاء اصطناعي للجسد', focusTime: 'وقت التركيز', taskCompleted: 'اكتملت المهمة', markAsDone: 'وضع علامة مكتمل؟', sessionDoneAuto: 'اكتملت الجلسة! المهمة مكتملة.', sessionDoneManual: 'انتهت الجلسة. هل اكتملت المهمة؟', earlyStop: 'توقفت الجلسة مبكراً.' }
  },
  // Deutsch (German)
  de: {
    ...
    session: { complete: 'Sitzung beendet!', focusedFor: 'Du warst fokussiert für', minutes: 'Minuten', avgFocus: 'Ø Fokus', posture: 'Haltung', timeline: 'Zeitstrahl', cycleLog: 'Zyklus-Log', backHome: 'Zurück', recharge: 'Aufladen', rest: 'Verdiente Pause', breathe: 'Tief atmen. In die Ferne schauen.', skipBreak: 'Pause überspringen', paused: 'Pausiert', focusGuard: 'Fokus-Wächter', proPosture: 'Pro: Haltung', fullBodyAi: 'Körper-KI', focusTime: 'Fokuszeit', taskCompleted: 'Aufgabe erledigt', markAsDone: 'Als erledigt markieren?', sessionDoneAuto: 'Sitzung beendet! Aufgabe erledigt.', sessionDoneManual: 'Sitzung beendet. Aufgabe fertig?', earlyStop: 'Vorzeitig beendet.' }
  },
  // हिन्दी (Hindi)
  hi: {
